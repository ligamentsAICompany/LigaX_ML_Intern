...
import { domainLabel, providerLabel } from '@/components/SessionFlow/domainOptions';
            ...
            return (
              <Box
                ...
                sx={{
                  ...
                  bgcolor: isSelected
                    ? 'var(--accent-green-weak)'
                    : 'transparent',
                  border: '1px solid',
                  borderColor: isSelected ? 'rgba(34,197,94,0.24)' : 'transparent',
                  '&:hover': {
              ...
              >
                ...
                <Box sx={{ flex: 1, minWidth: 0 }}>
                  ...
                  <Box sx={{ display: 'flex', gap: 0.4, mt: 0.6, flexWrap: 'wrap' }}>
                    <Chip
                      size="small"
                      label={domainLabel(session.vertical ?? session.domain_id)}
                      sx={{
                        height: 17,
                        fontSize: '0.56rem',
                        bgcolor: 'var(--hover-bg)',
                    ...
                    <Chip
                      size="small"
                      label={providerLabel(session.provider ?? session.provider_id)}
                      sx={{
                        height: 17,
                        fontSize: '0.56rem',
