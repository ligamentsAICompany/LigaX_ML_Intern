...
export default function AppLayout() {
  ...
  // -- Main chat interface ------------------------------------------------
  return (
      <Box sx={{ display: 'flex', width: '100%', height: '100%', bgcolor: 'var(--bg)' }}>
      {/* -- Left Sidebar ------------------------------------------------- */}
      {isMobile ? (
        sidebarDrawer
      ) : (
      ...
      >
        ...
        <Box sx={{
          ...
          <Box sx={{ flex: 1, display: 'flex', justifyContent: { xs: 'center', md: 'flex-start' }, alignItems: 'center', gap: 1.1, minWidth: 0, ml: { xs: 0, md: 1.25 } }}>
            <Box
              component="img"
              src="/smolagents.webp"
              alt="smolagents"
            ...
            <Box sx={{ minWidth: 0 }}>
              ...
              >
                Enterprise AI workflow cockpit
              </Typography>
            </Box>
            <Chip
              size="small"
              ...
              sx={{
                ...
                fontSize: '0.66rem',
                fontWeight: 800,
                bgcolor: isConnected ? 'var(--accent-green-weak)' : 'var(--accent-yellow-weak)',
                color: isConnected ? 'var(--accent-green)' : 'var(--accent-yellow)',
                border: '1px solid',
                borderColor: isConnected ? 'rgba(34,197,94,0.24)' : 'rgba(245,158,11,0.24)',
              }}
            />
          </Box>
